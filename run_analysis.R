...
y_labels <- read.table("R_Datasets/UCI_HAR_Dataset/activity_labels.txt")
x_labels <- read.table("R_Datasets/UCI_HAR_Dataset/features.txt")

#Load the test measures data and keep just the required columns
x_test <- read.table("R_Datasets/UCI_HAR_Dataset/test/X_test.txt")
